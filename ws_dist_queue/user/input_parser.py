...
class InputParser:
    ...
    def add_arguments(self):
        ...
        work_parser.add_argument('command', action='store', help='Command to be executed')
        ...
        kill_parser.add_argument('kill_work_id', type=int, help='Work id that should be killed')
